...
function addThreeToArray(arr){
  let threeMore = [];
for(element of arr){
   threeMore.push(addThree(element));
}
return threeMore;
}
/*
...
function filterAdult(arr){
  let newArray=[];
  for(element of arr){
       if(isAdult(element)==true){newArray.push(element);}
  }
  return newArray;
}
/*
...
function filterMale(arr){
  let newArray=[];
  for(element of arr){
       if(isMale(element)==true){newArray.push(element);}
  }
  return newArray;
}
/*
...
function filterFemale(arr){
  let newArray=[];
  for(element of arr){
       if(isFemale(element)==true){newArray.push(element);}
  }
  return newArray;
}
/*
...
function filterGradeA(arr){
  let newArray=[];
  for(element of arr){
       if(isGradeA(element)==true){newArray.push(element);}
  }
  return newArray;
}
/*
...
function filterGradeB(arr){
  let newArray=[];
  for(element of arr){
       if(isGradeB(element)==true){newArray.push(element);}
  }
  return newArray;
}
/*
...
function filterGradeC(arr){
  let newArray=[];
  for(element of arr){
       if(isGradeC(element)==true){newArray.push(element);}
  }
  return newArray;
}
/*
