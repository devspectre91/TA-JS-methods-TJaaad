...
/*
3. Log the message saying `The index of first is in quote is 6`
*/
...
*/
from.endsWith("rk") && to.endsWith("rk") && quote.endsWith("rk");//false
/*
...
*/
let quoteLarge = quote.padEnd(70, ".");
/*
16. Do same as (15) but the ... should come in start. Store the output in a new variable
*/
let quoteBig = quote.padStart(70, ".");
/*
...
*/
quote.startsWith("A") && to.startsWith("A") && from.startsWith("A");//false